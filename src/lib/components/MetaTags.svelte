<script lang="ts">
	...
	const structuredJSONData = JSON.stringify(structuredData);
</script>
...
<svelte:head>
	...
	<meta property="og:site_name" content="Tralee Orthotics" />
	...
	{@html `<script type="application/ld+json">${structuredJSONData}</script>`}
</svelte:head>
